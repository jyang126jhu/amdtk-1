...
utils/copy_data_dir_cmvn_utt.sh $srcdata $data; rm $data/{feats,cmvn}.scp 2>/dev/null
...
feats="$feats apply-cmvn $cmvn_opts scp:$srcdata/cmvn.scp ark:- ark:- | splice-feats --left-context=$left_context --right-context=$right_context ark:- ark:- |"
############# 2016-07-26 ###################
