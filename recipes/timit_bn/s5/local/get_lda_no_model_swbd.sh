...
case $feat_type in 
 ...
 cmvn) feats="ark,s,cs:utils/subset_scp.pl --quiet $N $sdata/JOB/feats_cmvn.scp | copy-feats scp:- ark:- |"
...
if [ $stage -le 3 ]; then
    ...
    splice-feats --left_context=$left_context --right_context=$right_context scp:$data/feats_cmvn.scp ark:- | transform-feats $dir/final.mat ark:- ark,scp:$ldadir/$datatype/feasts.ark,$ldadir/$datatype/feats.scp
    steps/compute_cmvn_stats.sh $ldadir/$datatype $cmvndir/lda_dim_${dim}_${posttype}_${datatype} $cmvndir/lda_dim_${dim}_${posttype}_${datatype}
